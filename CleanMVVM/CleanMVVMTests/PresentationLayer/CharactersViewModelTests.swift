...
class CharactersViewModelTests: XCTestCase {
    ...
    func testLoadMoreCharactersSuccess() {
        ...
        let characters = [
            CharacterEntity(id: 1, name: "Rick Sanchez", status: "Alive", species: "Human", image: "image_url", gender: "Male"),
            CharacterEntity(id: 2, name: "Morty Smith", status: "Alive", species: "Human", image: "image_url", gender: "Male")
        ]
...
class MockFetchCharactersUseCase: FetchCharactersUseCaseProtocol {
    ...
    func execute(page: Int) -> AnyPublisher<[CharacterEntity], any Error> {
